        ...
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <p class="text-sm text-secondary mb-3">{{ $customer->name }}</p>
                                </div>
                                <div class="col-6">
                                    <p class="text-sm mb-1"><strong>Company:</strong></p>
                                    <p class="text-sm text-secondary mb-3">{{ $customer->company }}</p>
                                </div>
                                <div class="col-6">
                                    <p class="text-sm mb-1"><strong>Email:</strong></p>
                                    <p class="text-sm text-secondary mb-3">{{ $customer->email }}</p>
                                </div>
                                <div class="col-6">
                                    <p class="text-sm mb-1"><strong>Phone:</strong></p>
                                    <p class="text-sm text-secondary mb-3">{{ $customer->phone }}</p>
                                </div>
                                <div class="col-6">
                                    <p class="text-sm mb-1"><strong>Region:</strong></p>
                                    <p class="text-sm text-secondary mb-3">{{ $customer->region }}</p>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="text-sm text-secondary mb-3">{{ $customer->address }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card bg-gradient-info">
                                        <div class="card-body p-3">
                                            <div class="text-center">
                                                <h4 class="text-white mb-0">{{ $customer->quotations->count() }}</h4>
                                ...
                                <div class="col-6">
                                    <div class="card bg-gradient-success">
                                        <div class="card-body p-3">
                                            <div class="text-center">
                                                <h4 class="text-white mb-0">{{ $customer->indents->count() }}</h4>
                                ...
                                <div class="col-6 mt-3">
                                    <div class="card bg-gradient-warning">
                                        <div class="card-body p-3">
                                            <div class="text-center">
                                                <h4 class="text-white mb-0">{{ $customer->debitNotes->count() }}</h4>
                                                <p class="text-white text-sm mb-0">Debit Notes</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6 mt-3">
                                    <div class="card bg-gradient-primary">
                                        <div class="card-body p-3">
                                            <div class="text-center">
                                                <h4 class="text-white mb-0">{{ $customer->created_at->format('M Y') }}</h4>
                        ...
                        <div class="col-12">
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @forelse($customer->quotations->take(5) as $quotation)
                                            <tr>
                                                <td>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center py-4">
                                                    <p class="text-secondary">No quotations found for this customer.</p>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <h6 class="mb-3">Recent Indents</h6>
                            <div class="table-responsive">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        @forelse($customer->indents->take(5) as $indent)
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        <div class="d-flex flex-column justify-content-center">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center py-4">
                                                    <p class="text-secondary">No indents found for this customer.</p>
                                                </td>
                                            </tr>
                                        @endforelse
                                    </tbody>
