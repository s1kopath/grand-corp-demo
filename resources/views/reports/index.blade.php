                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <span class="btn btn-sm btn-outline-light me-3">
                                    <i class="material-icons text-sm me-1">schedule</i>Auto-refresh: 5 min
                                </span>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                ...
                                                <h5 class="font-weight-bolder mb-0">{{ $reportStats['total_reports'] }}</h5>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Generated Today</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-end">
                                                <div
                                                    ...
                                                    <i class="material-icons opacity-10">{{ $report['icon'] }}</i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
